  ...
  return (
    <>
      <Card
        ...
        className={cn(
          "cursor-pointer group relative hover:border-primary/50 transition-colors",
      ...
      >
        ...
        <CardHeader className="p-3 pb-1 pr-8"> 
          <CardTitle className={cn(
              ...
              item.status === 'done' && "text-muted-foreground line-through decoration-muted-foreground/30"
          )}>
            {item.title}
          </CardTitle>
        </CardHeader>
        ...
        <CardFooter className="p-3 pt-2 text-[10px] text-muted-foreground flex justify-between items-center">
          <span className="truncate max-w-[120px]">{item.userEmail || "Anônimo"}</span>
