...
export function TransactionDetailsDialog({
  ...
  const [isRecurrenceUpdateDialogOpen, setIsRecurrenceUpdateDialogOpen] =
    useState(false); // Recurrence Dialog State
  const [pendingUpdateData, setPendingUpdateData] =
    useState<TransactionFormData | null>(null); // Store data while asking scope
              ...
              <div className="grid gap-6 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={`text-lg font-semibold ${transaction.type === "payable" ? "text-red-600" : "text-green-600"}`}
                    >
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {transaction.costCenterAllocation?.map((alloc, index) => (
                      ...
                      >
                        <span>
                          {costCenterNames[alloc.costCenterId] ||
                            alloc.costCenterId}
                        </span>
                  ...
                  <>
                    ...
                    <div className="text-xs text-muted-foreground space-y-1">
                      {transaction.approvedBy && (
                        <p>
                          Aprovado por:{" "}
                          {userNames[transaction.approvedBy] ||
                            transaction.approvedBy}{" "}
                          em{" "}
                      ...
                      {transaction.releasedBy && (
                        <p>
                          Pago/Liberado por:{" "}
                          {userNames[transaction.releasedBy] ||
                            transaction.releasedBy}{" "}
                          em{" "}
