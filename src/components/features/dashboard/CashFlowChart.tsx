...
import { AlertTriangle, Calendar, Maximize2, Minimize2 } from "lucide-react";
      ...
      <CardContent className="pl-2">
        {!hasCompanyStats && !isLoading && (
          <div className="flex items-center gap-2 bg-amber-50 dark:bg-amber-950/30 text-amber-700 dark:text-amber-400 text-xs rounded-md px-3 py-2 mb-2">
            ...
            <span>Saldo base calculado a partir de R$0,00. Recalcule o saldo para projeções mais precisas.</span>
          </div>
        )}
        {isLoading ? (
