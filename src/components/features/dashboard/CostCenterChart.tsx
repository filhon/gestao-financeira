...
import { BudgetProgressData, dashboardService } from "@/lib/services/dashboardService";
...
export function CostCenterChart() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            setIsLoading(true);
            try {
                const result = await dashboardService.getBudgetProgressByCostCenter(selectedCompany.id);
                setData(result);
            } catch (error) {
