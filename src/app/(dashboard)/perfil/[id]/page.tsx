...
const ROLE_DESCRIPTIONS: Record<UserRole | "none", string> = {
    admin: "Acesso total a todas as funcionalidades e configurações, incluindo gerenciamento de usuários e empresas.",
    financial_manager: "Gerencia transações, contas e relatórios financeiros da empresa. Pode criar e aprovar transações de qualquer centro de custo.",
...
export default function UserProfilePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                ...
                const allCostCenters = await costCenterService.getAll(selectedCompany.id);
                ...
                if (role && ['admin', 'financial_manager', 'auditor'].includes(role)) {
                    ...
                    visibleCostCenters = allCostCenters.filter(cc =>
    ...
    const currentRole = userProfile.companyRoles?.[selectedCompany?.id || ""] || "none";
        ...
        <div className="space-y-6">
            <div className="flex items-center gap-6">
                ...
                <div>
                    ...
                    <div className="mt-2 flex items-center gap-2">
                        <Badge variant={currentRole === "none" ? "secondary" : "default"} className="capitalize">
                            {currentRole === "none" ? "Sem Acesso" : (ROLE_LABELS[currentRole as UserRole] || currentRole)}
                        </Badge>
            ...
            <Tabs defaultValue="overview" className="w-full">
                <TabsList>
                    ...
                    <TabsTrigger value="cost-centers">Centros de Custo ({costCenters.length})</TabsTrigger>
                ...
                <TabsContent value="overview" className="space-y-6">
                            ...
                            <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                                ...
                                <div>
                                    <h4 className="font-semibold capitalize mb-1">
                                        {currentRole === "none" ? "Sem Função Definida" : (ROLE_LABELS[currentRole as UserRole] || currentRole)}
                                    </h4>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Contas com vencimento nos próximos 7 dias vinculadas a este usuário.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                            ...
                                            >
                                                ...
                                                <TableCell>
                                                    <Badge variant="outline" className="capitalize">
                                                        {t.status === 'pending_approval' ? 'Pendente' : t.status === 'approved' ? 'Aprovado' : t.status}
                                                    </Badge>
                                                </TableCell>
                                            </TableRow>
                                        ))
                ...
                <TabsContent value="cost-centers">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Centros de custo onde o usuário possui responsabilidades diretas (Aprovação/Pagamento) ou acesso total.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                {costCenters.map(cc => (
                                    <Card key={cc.id} className="overflow-hidden">
                                        ...
                                        <CardHeader className="pb-2">
                                            <CardTitle className="text-base truncate" title={cc.name}>{cc.name}</CardTitle>
                                        </CardHeader>
                                        <CardContent>
                                            <div className="space-y-4">
                                                ...
                                                <div className="space-y-1">
                                                    <div className="flex justify-between text-xs">
                                                        ...
                                                        <span className="font-medium">
                                                            ...
                                                            {(cc.budget || 0).toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}
                                                        </span>
                                                    </div>
                                                ...
                                                <div className="text-xs text-muted-foreground space-y-1">
                                                    ...
                                                    {(!cc.approverEmail || cc.approverEmail !== userProfile.email) &&
                                                        (!cc.releaserEmail || cc.releaserEmail !== userProfile.email) &&
                                                        ((['admin', 'financial_manager'].includes(currentRole as string))) && (
